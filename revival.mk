...
.PHONY: stage1 audit baseline preview-core-check map-intake-check map1b-check content1a-check clean-revival help content1a1-check content1a2-check tex1a-check vm4a-check tex1a2-check native-format-check format1b-check format1c-check format2a-check format3a-check format3b-check
...
help:
	@printf '%s\n' \
	  ...
	  '  make -f revival.mk format3b-check       Validate canonical-authority Native level persistence' \
...
format3b-check:
	@scripts/revival/validate_format3b.sh
